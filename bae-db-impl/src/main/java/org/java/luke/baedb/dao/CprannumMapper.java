...
public interface CprannumMapper {
	 ...
	 * @mbggenerated
	 */
	int countByExample(@Param("example") CprannumCriteria example);
	 ...
	 * @mbggenerated
	 */
	int deleteByExample(@Param("example") CprannumCriteria example);
	 ...
	 * @mbggenerated
	 */
	int insertSelective(@Param("record") Cprannum record);
	 ...
	 * @mbggenerated
	 */
	List<Cprannum> selectByExample(@Param("example") CprannumCriteria example, @Param("record_start") int record_start,
